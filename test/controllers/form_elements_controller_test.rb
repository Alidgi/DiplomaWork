...
class FormElementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create form_element" do
    assert_difference('FormElement.count') do
      post form_elements_url, params: { form_element: { element_id: @form_element.element_id, name: @form_element.name, value: @form_element.value } }
    end
  ...
  test "should update form_element" do
    patch form_element_url(@form_element), params: { form_element: { element_id: @form_element.element_id, name: @form_element.name, value: @form_element.value } }
